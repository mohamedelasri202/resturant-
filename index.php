        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right mu-main-nav">
            ...
            <li>
              ...
              <a href="/cheef/dist/pages/authentication-login.php" >
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="menu-card">
                                <div class="card-header">
                                    English Cuisine Menu
                                </div>
                                <div class="card-body p-0">
                                    <div class="menu-item">
                                        <img src="assets/img/menu/item-1.jpg" alt="English Starter">
                                        <div>
                                            <h4>English Starter</h4>
                                            <p class="text-muted mb-1">Traditional appetizer</p>
                                            <span class="badge bg-primary">$15.85</span>
                                        </div>
                                    </div>
                                    <div class="menu-item">
                                        <img src="assets/img/menu/item-1.jpg" alt="English Main Course">
                                        <div>
                                            <h4>English Main Course</h4>
                                            <p class="text-muted mb-1">Classic main dish</p>
                                            <span class="badge bg-primary">$22.85</span>
                                        </div>
                                    </div>
                                    <div class="menu-item">
                                        <img src="assets/img/menu/item-1.jpg" alt="English Dessert">
                                        <div>
                                            <h4>English Dessert</h4>
                                            <p class="text-muted mb-1">Sweet finish</p>
                                            <span class="badge bg-primary">$8.85</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="menu-card">
                                ...
                                <div class="card-body p-0">
                                    <div class="menu-item">
                                        <img src="assets/img/menu/item-2.jpg" alt="Chinese Starter">
                                        <div>
                                            <h4>Chinese Starter</h4>
                                            <p class="text-muted mb-1">Authentic appetizer</p>
                                            <span class="badge bg-primary">$11.95</span>
                                        </div>
                                    </div>
                                    <div class="menu-item">
                                        <img src="assets/img/menu/item-2.jpg" alt="Chinese Main Course">
                                        <div>
                                            <h4>Chinese Main Course</h4>
                                            <p class="text-muted mb-1">Signature main dish</p>
                                            <span class="badge bg-primary">$19.95</span>
                                        </div>
                                    </div>
                                    <div class="menu-item">
                                        <img src="assets/img/menu/item-2.jpg" alt="Chinese Dessert">
                                        <div>
                                            <h4>Chinese Dessert</h4>
                                            <p class="text-muted mb-1">Sweet delicacy</p>
                                            <span class="badge bg-primary">$7.95</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="menu-card">
                                ...
                                <div class="card-body p-0">
                                    <div class="menu-item">
                                        <img src="assets/img/menu/item-1.jpg" alt="Indian Starter">
                                        <div>
                                            <h4>Indian Starter</h4>
                                            <p class="text-muted mb-1">Spicy appetizer</p>
                                            <span class="badge bg-primary">$13.50</span>
                                        </div>
                                    </div>
                                    <div class="menu-item">
                                        <img src="assets/img/menu/item-1.jpg" alt="Indian Main Course">
                                        <div>
                                            <h4>Indian Main Course</h4>
                                            <p class="text-muted mb-1">Flavorful main dish</p>
                                            <span class="badge bg-primary">$21.50</span>
                                        </div>
                                    </div>
                                    <div class="menu-item">
                                        <img src="assets/img/menu/item-1.jpg" alt="Indian Dessert">
                                        <div>
                                            <h4>Indian Dessert</h4>
                                            <p class="text-muted mb-1">Sweet treat</p>
                                            <span class="badge bg-primary">$9.50</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
